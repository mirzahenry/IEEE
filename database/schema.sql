...
INSERT INTO site_settings (key, value, type) VALUES
  ...
  ('society_short_name', 'IEEE', 'text'),
  ('tagline', 'Exploring Earth. Advancing Technology. Inspiring the Next Generation.', 'text'),
  ('university_name', 'Your University Name', 'text'),
  ('department', 'Department of Geosciences', 'text'),
  ('email', 'contact@ieee.edu', 'text'),
  ('phone', '+1 234 567 8900', 'text'),
  ('address', 'University Campus, City, Country', 'text'),
